...
# dataset directory
data_dir = 'C:/Users/Alex/Desktop/Uni work/Year 3/AI for Creative Technologies/AI_Uni_Module/Python Game/Dataset'
...
for epoch in range(n_epochs):
    ...
    if valid_loss <= valid_loss_min:
        ...
        torch.save(model.state_dict(), './CNN_model.pt') # save in google drive
